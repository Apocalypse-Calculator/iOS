          ...
          >
            {({ handleChange, handleSubmit, values }) => (
              <KeyboardAwareScrollView style={{ paddingHorizontal: 25 }}>
                ...
                <Q2 item={item} itemColor={itemColor} onChangeText1={handleChange('currentStock')} value1={values.currentStock} onChangeText2={handleChange('handSanitizerVolume')} value2={values.handSanitizerVolume} switchEnabled={switchEnabled} setSwitchEnabled={setSwitchEnabled} />
